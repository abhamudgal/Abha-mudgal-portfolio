      ...
      <div className="self-center w-full">
        <div className="hs-tooltip [--placement:right] w-20 hs-tooltip-toggle">
          <img
            ...
            alt="Abha Mudgal Graduation Picture"
          />
        ...
        <div className="flex gap-6 lg:gap-8 align-center flex-wrap md:flex-nowrap">
          <div className="flex-1 min-w-0 text-zinc-900 dark:text-zinc-100 self-center">
            ...
            <div className="flex gap-2 mt-6 flex-wrap">
              <a
                href="https://docs.google.com/document/d/1g2nOtbihtuT1eEHzFPoKcNNvkUPQX_a0D5VgN1ckjQY/edit?usp=sharing"
                target="_blank"
              ...
              <a
                href="https://leetcode.com/u/Abhamudgal/"
                target="_blank"
                className="px-6 py-3 border border-black hover:bg-red-800 hover:text-white hover:border-red-800 dark:border-white font-medium transition-all duration-300"
              >
                LeetCode
              ...
              <a
                href="https://github.com/Abhamudgal"
                target="_blank"
                className="px-6 py-3 border border-black hover:bg-red-800 hover:text-white hover:border-red-800 dark:border-white font-medium transition-all duration-300"
              >
                Github
          ...
          <div className="hidden lg:block flex-shrink-0 w-[380px] xl:w-[420px] self-center">
            <img
              className="rounded-[10%] transform rotate-3 w-full"
              src={user_info.main.photo}
              alt="Abha Mudgal Graduation Picture"
            />
          </div>
