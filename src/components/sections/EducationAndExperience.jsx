...
import { FaBuildingUser, FaCertificate } from "react-icons/fa6";
              ...
              {user_info.certificates.map((cert, index) => {
                return (
                  <div className="hs-carousel-slide relative" key={index}>
                    {/* Certificate Icon */}
                    <FaCertificate className="text-red-400 absolute left-1/2 top-5 text-3xl transform -translate-x-1/2" />

                    <div className="flex justify-center items-center h-full bg-gray-100 p-6 dark:bg-neutral-900">
                      <div className="relative flex flex-col items-center text-center">
                        {/* Certificate Link & Details */}
                        <a href={cert.link} target="_blank" rel="noreferrer" className="text-gray-800 dark:text-white hover:text-red-800 hover:dark:text-red-500">
                          {/* Certificate Title */}
                          <p className="transition duration-700 px-6 font-bold">
                            {cert.title}
                          </p>
                          {/* Certificate Description */}
                          <p className="text-red-500 transition duration-700 px-6 text-sm">
                            {cert.description}
                          </p>
                        </a>
                        ...
                        <a href={cert.link} target="_blank" rel="noreferrer"
                          className="absolute bottom-[-35px] left-1/2 transform -translate-x-1/2 py-1 px-3 bg-white border dark:border-zinc-800 dark:bg-zinc-950 text-xs font-medium dark:text-white rounded shadow-sm whitespace-nowrap h-8 flex items-center">
                          Open Certificate
                        </a>
                      </div>
                    </div>
